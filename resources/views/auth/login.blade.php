...
<head>
  ...
  <style>
    * {
    ...
    .scaled-content {
      transform: scale(0.7); /* Sesuaikan scale sesuai kebutuhan: 0.6, 0.7, 0.8 */
...
<body>
  <div class="wrapper">
    <div class="scaled-content">
      <form method="POST" action="{{ url('/login') }}" style="width: 1920px; height: 1080px; position: relative; background: white; box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25); overflow: hidden; outline: 1px black solid; outline-offset: -1px">
        @csrf
        ...
        <input type="text" name="username" placeholder="Username" style="width: 330px; height: 45px; left: 303px; top: 498px; position: absolute; background: rgba(217, 217, 217, 0); border-radius: 12px; border: 1px #C9C9C9 solid; padding-left: 10px; font-size: 13px; font-family: Poppins; font-weight: 400; color: #3F3E3E;" />
