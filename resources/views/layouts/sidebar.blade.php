        ...
        <ul class="metismenu" id="menu">
            {{-- <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    ...
                    <li><a href="/" class="">Dashboard Light</a></li>
                    <li><a href="/index-dark" class="">Dashboard Dark</a></li>
                    <li><a href="/index-2">Dashboard 2</a></li>
                    <li><a href="/index-3">Dashboard 3</a></li>
                    <li><a href="/index-4">Dashboard 4</a></li>
            ...
            <li><a href="/dashboard" class="" aria-expanded="false">
                    <div class="menu-icon">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path d="M3 13H9V21H3V13ZM10 3H14V21H10V3ZM15 8H21V21H15V8Z" fill="#90959F" />
                        </svg>
                    </div>
                    <span class="nav-text">Dashboard</span>
                </a></li>
            <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    <li><a href="/kriteria">Kriteria 1</a></li>
                    <li><a href="/kriteria">Kriteria 2</a></li>
                    <li><a href="/kriteria">Kriteria 3</a></li>
                    <li><a href="/kriteria">Kriteria 4</a></li>
                    <li><a href="/kriteria">Kriteria 5</a></li>
                    <li><a href="/kriteria">Kriteria 6</a></li>
                    <li><a href="/kriteria">Kriteria 7</a></li>
                    <li><a href="/kriteria">Kriteria 8</a></li>
                    <li><a href="/kriteria">Kriteria 9</a></li>
                    <li><a href="/kriteria">Suplemen</a></li>
                </ul>
            </li>
            <li><a href="/project" class="" aria-expanded="false">
                    <div class="menu-icon">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
            ...
            {{-- <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    <li><a href="/chat">Kriteria 1</a></li>
                    ...
                    <li><a class="has-arrow" href="javascript:void(0);" aria-expanded="false">Shop</a>
                        <ul aria-expanded="false">
                            <li><a href="/ecom-product-grid">Product Grid</a></li>
                            <li><a href="/ecom-product-list">Product List</a></li>
                            <li><a href="/ecom-product-detail">Product Details</a></li>
                            <li><a href="/ecom-product-order">Order</a></li>
                            <li><a href="/ecom-checkout">Checkout</a></li>
                            <li><a href="/ecom-invoice">Invoice</a></li>
                            <li><a href="/ecom-customers">Customers</a></li>
                        </ul>
                    </li>
                </ul>
            </li> --}}
            ...
            {{-- <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    <li><a href="/uc-select2">Select 2</a></li>
                    <li><a href="/uc-nestable">Nestable</a></li>
                    <li><a href="/uc-noui-slider">Noui Slider</a></li>
                    <li><a href="/uc-sweetalert">Sweet Alert</a></li>
                    <li><a href="/uc-toastr">Toastr</a></li>
                    <li><a href="/map-jqvmap">Jqv Map</a></li>
                    <li><a href="/uc-lightgallery">Light Gallery</a></li>
                </ul>
            </li> --}}
            {{-- <li><a href="widget-basic" class="" aria-expanded="false">
                <div class="menu-icon">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g opacity="0.5">
            ...
            {{-- <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    <li><a href="/form-element">Form Elements</a></li>
                    <li><a href="/form-wizard">Wizard</a></li>
                    <li><a href="/form-ckeditor">CkEditor</a></li>
                    <li><a href="form-pickers">Pickers</a></li>
            ...
            {{-- <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    <li><a href="table-bootstrap-basic">Bootstrap</a></li>
                    <li><a href="table-datatable-basic">Datatable</a></li>
                </ul>
            </li> --}}
            {{-- <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                    <div class="menu-icon">
                ...
                <ul aria-expanded="false">
                    ...
                    <li><a href="/empty-page">Empty Page</a></li>
                </ul>
            </li> --}}
        </ul>
    </div>
