...
<div class="deznav">
    <div class="deznav-scroll">
        <ul class="metismenu" id="menu">
            ...
            <li>
                <a class="has-arrow {{ request()->routeIs('kriteria.*') ? 'active' : '' }}" href="javascript:void(0);"
                    aria-expanded="false">
                    <div class="menu-icon">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                ...
                <ul aria-expanded="false">
                    @for ($i = 1; $i <= 9; $i++)
                        <li>
                            <a href="{{ route('kriteria.show', $i) }}"
                                class="{{ request()->routeIs('kriteria.show') && request()->route('id') == $i ? 'active' : '' }}">
                                Kriteria {{ $i }}
                            </a>
                        </li>
                    @endfor
                    <li>
                        <a href="{{ route('kriteria.suplemen') }}"
                            class="{{ request()->routeIs('kriteria.suplemen') ? 'active' : '' }}">
                            Suplemen
                        </a>
                    </li>
                </ul>
            ...
            <li>
                <a class="has-arrow {{ request()->routeIs('users.*') ? 'active' : '' }}" href="javascript:void(0);"
                    aria-expanded="false">
                    <div class="menu-icon">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
