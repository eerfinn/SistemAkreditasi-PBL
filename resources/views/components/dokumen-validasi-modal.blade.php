        ...
        <div class="modal-content">
            ...
            <form action="{{ route('validasi.update-status', $dokumen->id) }}" method="POST">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        <label class="form-label text-start d-block">Dokumen: <strong>{{ $dokumen->nama_dokumen }}</strong></label>
                        <p class="small text-muted mb-3 text-start">ID: {{ $dokumen->id }} | Status: {{ ucfirst($dokumen->status) }}</p>
